...
namespace System.Net.Sockets
{
    public static class SocketExtension
    {
        ...
        public static async Task<int> SendAsync(this UdpClient client, string msg, IPEndPoint endPoint, Encoding encoding = null)
        {
            if (encoding == null)
                encoding = Encoding.UTF8;
            var data = encoding.GetBytes(msg);
            return await client.SendAsync(data, data.Length, endPoint);
        }
        ...
        public static int Send(this UdpClient client, string msg, IPEndPoint endPoint, Encoding encoding = null)
        {
            if (encoding == null)
                encoding = Encoding.UTF8;
            var data = encoding.GetBytes(msg);
